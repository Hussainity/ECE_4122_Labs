...
int main()
{
	...
	const ECE_Matrix M3("test.txt"); // Construct matrix from file
	...
	const ECE_Matrix M19;
	const ECE_Matrix M20(3, 5.0);
	const ECE_Matrix M21 = M20 / 0;

	std::cout << "M21: " << std::endl << M21 << std::endl;
	std::cout << "M19: " << std::endl << M19 << std::endl;
	std::cout << "M11: " << std::endl << M11 << std::endl;
	std::cout << "M12: " << std::endl << M12 << std::endl;
